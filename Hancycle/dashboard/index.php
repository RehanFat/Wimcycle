            ...
            <div class="col-lg-3">
                <div class="card text-bg-primary">
                    <div class="card-body">
                        ...
                        <h2 class="pb-3"><?= count($data_sepeda) ?></h2>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Tambahkan Data Sepeda Baru</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form>
                                    <div class="mb-3">
                                        <label for="exampleInput" class="form-label">Merek</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInput" class="form-label">Tipe</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="mb-3">
            ...
            <tbody>
                <?php foreach ($new_data_sepeda as $sepeda) : ?>
                    <tr>
                        ...
                        <td><?= $sepeda['model'] ?></td>
                        <td><?= "Rp." . $sepeda['harga'] ?></td>
                        <td>-</td>
                        <td><?= $sepeda['deskripsi'] ?></td>
                        <td>
                            <div class="d-flex gap-3">
                                ...
                                <div class="modal fade" id="exampleModal<?php echo $sepeda['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Delete Data <?= $sepeda['merek'] ?></h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <p>Apakah anda yakin untuk menghapus data sepeda <b><?= $sepeda['merek'] ?></b></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                ...
                                <div class="modal fade" id="exampleModalUpdate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Update Data <?= $sepeda['merek'] ?></h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form>
                                                    <div class="mb-3">
                                                        <label for="exampleInput" class="form-label">Merek</label>
                                                        <input type="text" class="form-control" value="<?= $sepeda['merek'] ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInput" class="form-label">Tipe</label>
                                                        <input type="text" class="form-control" value="<?= $sepeda['model'] ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInput" class="form-label">Harga</label>
                                                        <input type="number" class="form-control" value="<?= $sepeda['harga'] ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInput" class="form-label">Deskripsi</label>
                                                        <textarea name="deskripsi" class="form-control"><?= $sepeda['deskripsi'] ?></textarea>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="modal-footer">
